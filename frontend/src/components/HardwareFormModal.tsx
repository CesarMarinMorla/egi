...
export default function HardwareFormModal({
  open,
  hardware,
  onClose,
  onSubmit,
  ...
  return (
    <Modal
      open={open}
      title={isEdit ? 'Editar hardware' : 'Agregar hardware'}
      onClose={onClose}
    >
        ...
        <div className="form-grid">
          ...
          <label className="field">
            ...
            <input
              value={form.cpu}
              onChange={(e) =>
                setForm((prev) => ({ ...prev, cpu: e.target.value }))
              }
              required
              disabled={isSaving}
            />
          ...
          <label className="field">
            ...
            <input
              ...
              value={form.ramGb}
              onChange={(e) =>
                setForm((prev) => ({ ...prev, ramGb: Number(e.target.value) }))
              }
              required
              disabled={isSaving}
            />
          ...
          <label className="field">
            ...
            <input
              ...
              value={form.diskGb}
              onChange={(e) =>
                setForm((prev) => ({ ...prev, diskGb: Number(e.target.value) }))
              }
              required
              disabled={isSaving}
            />
          ...
          <label className="field form-grid__wide">
            ...
            <input
              value={form.os}
              onChange={(e) =>
                setForm((prev) => ({ ...prev, os: e.target.value }))
              }
              required
              disabled={isSaving}
            />
          ...
          <label className="field">
            ...
            <input
              value={form.monitor}
              onChange={(e) =>
                setForm((prev) => ({ ...prev, monitor: e.target.value }))
              }
              required
              disabled={isSaving}
            />
          ...
          <label className="field">
            ...
            <input
              value={form.mouse}
              onChange={(e) =>
                setForm((prev) => ({ ...prev, mouse: e.target.value }))
              }
              required
              disabled={isSaving}
            />
