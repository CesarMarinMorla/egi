...
| `ping 192.168.1.102` (SQL) | ❌ No funciona |
| `nc 192.168.1.102 1433` (SQL) | ❌ No funciona |

> **Nota:** SQL Server (`192.168.1.102`) no responde a ping ni al puerto 1433 desde Ubuntu Server. Verificar si la VM de SQL Server está encendida, si el firewall de Windows permite ICMP y el puerto 1433, o si pfSense está bloqueando el tráfico entre VMs.
